 ...
 * @author vily0
 */
public class SistemaFarmaciaMDI extends javax.swing.JFrame {

   private JInternalFrameCompras Compras;
    
    public SistemaFarmaciaMDI() {
        initComponents();
        setTitle("Productos");
        Compras= new JInternalFrameCompras();
    ...
    private void initComponents() {
        ...
        verProductosMenuItem.setMnemonic('d');
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaFarmaciaMDI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SistemaFarmaciaMDI().setVisible(true);
            }
        });
    }
